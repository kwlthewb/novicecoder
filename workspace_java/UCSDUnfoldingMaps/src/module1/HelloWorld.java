...
public class HelloWorld extends PApplet
{
	...
	public static String mbTilesString = "blankDark-1-3.mbtiles";
	...
	public void setup() {
	    ...
	    // map2.zoomAndPanTo(zoomLevel, new Location(40.63f, -74.0f)); // New York
	    map2.zoomAndPanTo(zoomLevel, new Location(22.35f, 114.1f)); // Hong Kong
